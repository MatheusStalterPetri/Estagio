...
export declare class FilterController<T extends object> implements ReactiveController {
    ...
    state: FilterState<T>;
    get filterRow(): import("../components/filter-row").default<T>;
    hostConnected(): void;
    hostUpdate(): void;
    get(key: Keys<T>): import("../operations/filter/tree").FilterExpressionTree<T> | undefined;
    reset(key?: Keys<T>): void;
    setActiveColumn(column?: ColumnConfiguration<T>): void;
    getDefaultExpression(column: ColumnConfiguration<T>): FilterExpression<T, keyof T>;
