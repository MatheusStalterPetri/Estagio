...
class ct {
  ...
  getDefaultExpression(e) {
    const i = typeof e.filter == "boolean" ? !1 : Boolean(e.filter?.caseSensitive), r = W(e), a = Object.keys(r);
    return {
      key: e.key,
      condition: r[a[0]],
      caseSensitive: i
...
let d = class extends St {
  constructor() {
    super(...arguments), this.stateController = new wt(this), this.DOM = new $t(this, this.stateController), this.dataController = new kt(this), this.stateProvider = new Pe(this, F, this.stateController), this.dataState = [], this.columns = [], this.data = [], this.autoGenerate = !1, this.sortConfiguration = {
      multiple: !0,
      triState: !0
    };
  }
